...
export class ApplicationQuestion {
  ...
  @ManyToOne(
    () => Organization,
    organization => organization.application_questions,
    { nullable: true }
  )
  ...
  @ManyToOne(() => Project, project => project.application_questions, {
    nullable: true,
  })
  ...
  @ManyToOne(() => Position, position => position.application_questions, {
    nullable: true,
  })
